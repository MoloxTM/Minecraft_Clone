...
public class FontManager {
    ...
    public void addCharacter(FontMesh fontMesh, float x, float y, float scale, CharInfo charInfo, int rgb) {
    ...
    public void addText(FontMesh fontMesh, String text, int x, int y, float scale, int rgb) {
        for (int i = 0; i < text.length(); i++) {
            ...
            this.addCharacter(fontMesh, x, y, scale, charInfo, rgb);
